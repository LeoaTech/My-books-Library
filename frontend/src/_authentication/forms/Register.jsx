...
const Register = () => {
    ...
    const { isLoading, error, regeisterUser, message } = useSignup();

    const { errors, isValid, isDirty, isSubmitting, isSubmitSuccessful } =
        formState;
    const onSubmit = async (data) => {
        console.log(data);
        await regeisterUser(data);

    };

    // console.log(isValid, "Form", errors);
                ...
                <div className="overflow-y-auto p-6 sm:p-10 max-h-[calc(100vh-300px)]">
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Type of Books */}
                            <div>
                                <label className="block mb-1 text-gray-700">Type of Books</label>
                                <select
