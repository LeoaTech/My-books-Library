...
const NewArrivalBooks = () => {
  ...
  return (
    <section className="new-arrivals-container">
        ...
        <h1 className="heading title inline-block border-b-2 border-white font-extrabold">New Arrivals</h1>
      ...
      >
        <div className={`${isHovered ? 'animate-none' : 'animate-infinite-slider'} flex w-[calc(250px*10)] gap-4`}
