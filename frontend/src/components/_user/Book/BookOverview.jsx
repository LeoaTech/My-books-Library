...
const BookOverview = () => {
  ...
  return (
    <section className="mt-4 overflow-hidden text-gray-100">
      {book && (
        <div className="container px-5 pt-32 pb-4 mx-auto sm:py-24">
            ...
            <div className="w-full mt-6 lg:w-2/3 lg:pl-10 lg:py-6 lg:mt-0">
              <h2 className="relative text-md font-semibold tracking-widest text-purple-900 title-font">
                ...
                <div className="absolute right-0 sm:bottom-4 sm:relative bottom-24">
                  <button type="button" className="absolute right-0 w-12 h-12 text-white rounded-full top-1">
                    <svg
              ...
              <div className='flex items-center mb-2'>
                {stars}
                <h6 className="text-md  font-semibold px-2.5 py-0.5 rounded bg-purple-900 bg-opacity-80 text-white">
                  {(book.reviews.reduce((acc, review) => acc + review.rating, 0) / book.reviews.length).toFixed(1)}
                </h6>
              </div>
              <div className="book-detail mb-4">
                <ul className="text-white font-medium book-info list-none p-0 flex items-center gap-4">
              ...
              <div className="flex items-baseline my-4">
                ...
                <div className="flex ml-auto gap-4 font-extrabold">
                  <button className="w-20 bg-white rounded p-2">Borrow</button>
                  <button className="w-20 bg-white rounded p-2">Buy</button>
                </div>
              </div>
            </div>
          </div>
          <div className="flex flex-wrap mx-auto text-purple-900 lg:max-w-5xl">
            <div className="flex gap-8">
              <div className="w-full sm:w-1/4 lg:w-1/2 flex flex-col content-center py-4 text-purple-900">
              ...
              <div className="ml-4 w-full sm:w-1/4 lg:w-1/2 flex flex-col py-4 text-white">
                <h1 className="font-semibold title border-l-4 border-black px-2">Related Books</h1>
