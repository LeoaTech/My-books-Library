    ...
    <div className="flex flex-col gap-4 mt-4 ml-4">
      {books.map((book) => {
        return (
          <article
            key={book.id}
            className="w-3/4 bg-purple-300 rounded-lg p-4 text-center flex items-start gap-4"
          >
            <Link to="/book">
              <img
                src={book.img}
            ...
            <div className="flex flex-col items-start">
              <Link to="/book">
                <h1 className="tracking-tight text-lg font-bold">
                  {book.title}
                </h1>
              </Link>
              ...
              <div className="flex gap-4 text-black font-semibold">
                <button
                  type="button"
                  className="bg-white w-20 py-2 px-4 rounded"
                >
                  Buy
                </button>
                <button
