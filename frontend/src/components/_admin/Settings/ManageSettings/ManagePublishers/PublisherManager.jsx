...
function PublisherManager() {
    ...
    const { data: publishersData, isLoading } = useFetchPublishers();

    const { addPublisher, updatePublisher, deletePublisher } = usePublisher();
    ...
    const handleView = (publisher) => {
        const viewPublisher = publishersData?.publishers?.find((aut) => aut.id == publisher);

        setViewData(viewPublisher);
    };
    ...
    return (
        <div>
            ...
            {(!publishersData || publishersData?.publishers?.length === 0) ? (
                    ...
                    <div className="bg-neutral-50 dark:border-[#2E3A47] dark:bg-[#24303F] p-6 rounded shadow-lg">
                        ...
                        <div className=" md:mx-20">
                            ...
                            <div className='flex justify-between gap-4'>
                                <button
                                    onClick={() => deletePublisherData(value)}
