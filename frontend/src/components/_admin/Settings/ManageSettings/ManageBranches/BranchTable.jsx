...
const BranchTable = ({ data, onView, onEdit, onDelete }) => {
  ...
  return (
    <div className="rounded-lg border border-border bg-surface px-5 pt-6 pb-2.5 shadow-default max-w-full overflow-x-auto overflow-y-auto sm:px-7.5 xl:pb-1">
        ...
        <table className="w-full table-auto divide-y divide-primary">
          ...
          <tbody className="divide-y divide-border bg-background">
            {currentRows?.map((branch) => (
              <tr key={branch?.id} className="hover:bg-surface transition-colors">
                ...
                <td className="border-b border-secondary py-5 px-4">
                  ...
                  <p
                    className="inline-flex  py-1 px-3 text-sm font-medium text-text"
                  >
                    {branch?.country}
                  </p>
                </td>
                  ...
                  <div className="flex items-center space-x-3.5">
                    <div className="group relative m-2 flex justify-center">
                      ...
                      <button
                        ...
                        disabled={branch.role_name == "owner"}
                      >
                    ...
                    {/* Temporarily hiding the delete button*/}
                    {/* <button
      ...
      {/* Pagination controls */}
      <div className="flex justify-start md:justify-end gap-4 mt-5 mb-5">
        <button
