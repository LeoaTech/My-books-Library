...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const [openId, setOpenId] = useState(null); // Track open submenu ID
              ...
              {routes?.map((route) => (
                <li key={route.title}>
                  ...
                  {!route?.subRoutes ? (
                    ...
                    <SidebarLinkGroup
                      activeCondition={route.subRoutes.some((r) => pathname === r.path)}
                      id="settings" openId={openId} setOpenId={setOpenId}>
