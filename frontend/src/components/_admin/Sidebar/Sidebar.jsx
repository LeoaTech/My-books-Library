...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
                                  ...
                                  {route.subRoutes.map((subRoute, subIndex) => (
                                    ...
                                    >
                                      <Link
                                        to={subRoute.path}
                                        className={({ isActive }) =>
                                          "group relative flex flex-row justify-between items-center gap-2.5 rounded-md px-4 font-medium text-[#8A99AF] duration-300 ease-in-out hover:text-white " +
                                          (isActive && "text-white")
                                        }
                                      >
                          ...
                          >
                            {route?.subRoutes &&
                              route.subRoutes?.map((subRoute) => (
                                <ul
                                  key={subRoute?.title}
                                  className="mt-4 mb-0.5 flex flex-col gap-2.5 pl-6 text-[#AEB7C0]"
                                >
                                  <li className="ml-5 hover:text-white">
                                    <Link
                                      to={subRoute?.path}
                                      className={({ isActive }) =>
                                        "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-[#8A99AF] duration-300 ease-in-out hover:text-white " +
                                        (isActive && "!text-white")
                                      }
                                    >
                                      {subRoute?.title}
                            ...
                            <li className="hover:text-white active:text-white">
                              {auth?.auth ? (
                                <Link
                                  ...
                                  onClick={signout}
                                  className={({ isActive }) =>
                                    "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:text-white " +
                                    (isActive && "!text-white")
                                  }
                                >
                                  <span className="flex items-center gap-2.5">
  ...
  //                 to="/dashboard/qc"
  //                 className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-[#313D4A] ${
  //                   pathname.includes("qc") && "bg-[#333A48] dark:bg-[#313D4A]"
  //                 }`}
  //               >
  ...
  //                 className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-[#DEE4EE] duration-300 ease-in-out hover:bg-[#333A48] dark:hover:bg-[#313D4A] ${
  //                   pathname.includes("tables") && "bg-[#333A48] dark:bg-[#313D4A]"
  //                 }`}
  //               >
  //                 <svg
  //                   className="fill-current"
  ...
  //                         }`}
  //                       >
  //                         <ul className="mt-4 mb-0.5 flex flex-col gap-2.5 pl-6 text-[#AEB7C0]">
  //                           <li className="ml-5 hover:text-white">
  //                             <Link
  //                               to="/dashboard/users"
  //                               className={({ isActive }) =>
  ...
  //                       }`}
  //                     >
  //                       <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6 text-[#DEE4EE]">
  //                         <li className="hover:text-white active:text-white">
  //                           <Link
