            ...
            {users?.map((user) => (
              <tr key={user?.id}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <p className="inline-flex rounded-full bg-success bg-opacity-10 py-1 px-3 text-sm font-medium text-meta-4">
                    {user.role_name}
                  </p>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <span className="flex items-center gap-1">
                    {user?.permissions?.map((per, index) => (
                      <p
                        key={index}
                        className="inline-flex rounded-full bg-meta-7 bg-opacity-10 py-1 px-3 text-sm font-medium text-meta-8"
                      >
                        {per}
                      </p>
                    ))}
