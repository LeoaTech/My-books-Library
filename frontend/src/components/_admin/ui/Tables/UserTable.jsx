...
const UserTable = ({ users }) => {
  ...
  return (
    <div className="rounded-lg border border-[#E2E8F0] bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-[#2E3A47] dark:bg-[#AEB7C0] sm:px-7.5 xl:pb-1">
            ...
            {users?.map((user) => (
              <tr key={user?.user_id}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-[#2E3A47]">
                  <p className="inline-flex rounded-full bg-[#219653] bg-opacity-10 py-1 px-3 text-sm font-medium text-[#313D4A]">
                    {user.name}
                  </p>
                </td>
                <td className="border-b border-[#eee] py-5 px-4 dark:border-[#2E3A47]">
