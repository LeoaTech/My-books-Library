            ...
            <table className="w-full table-auto">
              <thead>
                <tr className="bg-[#f0f5fc] text-left dark:bg-[#313D4A]">
                  ...
                  <th className="min-w-[200px] break-words py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                    Full Name
                  </th>
                ...
                {filteredOrders?.length == 0 ? (
                  ...
                  currentRows?.map((order) => (
                    <tr key={order?.id}>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-[#2E3A47] xl:pl-11">
                        {new Date(order?.order_on).toDateString()}
                      </td>
      ...
      {filteredOrders?.length > 0 && (
        <div className="flex justify-end gap-4 mt-5">
          <button
            ...
            className="disabled:text-slate-300 dark:disabled:text-slate-600 text-blue-900"
          >
